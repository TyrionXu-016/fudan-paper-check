...
CORS_ORIGINS=https://api-mse.tyrion.space,http://api-mse.tyrion.space,http://114.55.139.240,http://localhost:3000
APP_BASE_URL=https://api-mse.tyrion.space
...
EOF
  ...
  set_env_default "APP_BASE_URL" "https://api-mse.tyrion.space"

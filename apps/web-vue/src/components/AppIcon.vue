...
const props = withDefaults(
  defineProps<{ name: string; size?: number; sw?: number }>(),
  { size: 16, sw: 1.75 },
)
...
const ICONS: Record<string, string> = {
  ...
  file:
    '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="14" y2="13"/><line x1="8" y1="17" x2="14" y2="17"/>',
  search:
  ...
  reset:
    '<polyline points="3 6 4 6 5 6 7.4 6 12 6 17 6 21 6"/><path d="M19 6V20a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>',
  download:

...
| 姓名 | 角色 | 职责 | 年级/专业 |
|---|---|---|---|
| 管慧君 | 项目经理兼产品经理 | 统筹进度、定义交付标准、制定测试集、组织效果评测和资源协调 | 研一/电子信息 |
| 王诗琪 | 数据清洗与知识库工程师 | 使用 MinerU/Marker/Pandoc 等工具清洗规范文档，整理 Markdown 和 RAG 知识库材料 | 研一/电子信息 |
| 尚国瑞 | 数据清洗与知识库工程师 | 规范材料清洗、分层切片、元数据标注和向量库/索引导入 | 本一/信息安全 |
| 赵思远 | 算法与微调工程师 | 构建微调数据集，进行 LoRA/QLoRA 微调和 Prompt 调优 | 本一/信息安全 |
| 徐阳 | 算法与微调工程师 | 模型调用、Agent 流水线、结构化输出和后处理优化 | 本一/研一/电子信息 |
| 黄婧雯 | 前端开发及 UI 设计工程师 | 论文上传、规范选择、报告查看、纠错对比等前端界面开发 | 本一/计算机科学与技术 |
